...
type ImageRegistryConfigStorageIBMCOS struct {
	...
	// +optional
	Bucket string `json:"bucket,omitempty"`
	// region is the IBM Cloud location in which your bucket exists.
	// Optional, will be set based on the installed IBM Cloud region.
	// +optional
	Region string `json:"region,omitempty"`
	// resourceGroup is the name of the IBM Cloud resource group that this
